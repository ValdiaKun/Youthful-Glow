...
struct V2FeatureMenu: View {
    ...
    enum SmartFeature: String, Identifiable {
        case progress, intelligence, reminders, photos, discovery, recommendations, alternatives
            ...
            ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        featureButton(.discovery, "Discover Products", "Philippine-market recommendations for sunscreen, hydration, brightening and more.", "bag.fill")
                        featureButton(.recommendations, "Personalized Picks", "Build a routine around your goal, skin type, budget and preferred routine complexity.", "wand.and.stars")
                        featureButton(.alternatives, "Product Alternatives", "Find similar products, cheaper options and basic routine-compatibility guidance.", "arrow.triangle.swap")
